...
7. `[확인]` **형식·분량·가독성**: 분량은 CLAUDE.md 「분량 기준」과 대조하고 섹션 순서 위주로 본다. **상한 안이면 분량을 지적하지 않는다** — 목표(2p)를 넘겼다는 것만으로 감축을 요구하면 JD 접점이 있는 내용이 잘려나간다. review와 겹치는 세부 문장 길이 재지적은 생략.
